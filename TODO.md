...
- 🚧 Native tracker state events are in progress. Shipped so far: normalized native state aliases, Linear webhook ingress, and a generic trigger-source model that can represent repo-backed and tracker-project sources. Remaining work: non-repo polling connectors (starting with Linear/Jira) and richer tracker-side payload hydration. Design: [`docs/superpowers/specs/2026-05-10-rupu-native-tracker-state-events-design.md`](docs/superpowers/specs/2026-05-10-rupu-native-tracker-state-events-design.md). Plan 1: [`docs/superpowers/plans/2026-05-10-rupu-native-tracker-state-events-plan-1-foundation-and-linear-webhooks.md`](docs/superpowers/plans/2026-05-10-rupu-native-tracker-state-events-plan-1-foundation-and-linear-webhooks.md).
