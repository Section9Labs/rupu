...
- 🚧 Native tracker state events are in progress. Shipped so far: normalized native state aliases, Linear webhook ingress, Linear team polling, Jira webhook ingress, Jira project polling, and a generic trigger-source model that can represent repo-backed and tracker-project sources. Remaining work: richer tracker-side payload hydration, GitHub Projects mapping, and tracker-native autoflow ownership. Event design: [`docs/superpowers/specs/2026-05-10-rupu-native-tracker-state-events-design.md`](docs/superpowers/specs/2026-05-10-rupu-native-tracker-state-events-design.md). Ownership design: [`docs/superpowers/specs/2026-05-10-rupu-tracker-native-autoflow-ownership-design.md`](docs/superpowers/specs/2026-05-10-rupu-tracker-native-autoflow-ownership-design.md). Ownership plan: [`docs/superpowers/plans/2026-05-10-rupu-tracker-native-autoflow-ownership-plan-1.md`](docs/superpowers/plans/2026-05-10-rupu-tracker-native-autoflow-ownership-plan-1.md).
