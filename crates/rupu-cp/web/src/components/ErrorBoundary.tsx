    ...
    if (this.state.error) {
      return (
        <div className="min-h-screen flex items-start justify-center px-4 py-16 bg-bg">
          <div className="max-w-2xl w-full bg-panel border border-err/30 rounded-xl shadow-card p-6">
            <div className="flex items-center gap-2 text-err mb-3">
            ...
            <pre className="text-xs bg-err-bg border border-err/30 rounded-md p-3 overflow-auto max-h-48 text-err font-mono whitespace-pre-wrap">
...
{this.state.error.stack && '\n\n' + this.state.error.stack}
            ...
            {this.state.componentStack && (
              <details className="mt-3">
                ...
                <pre className="text-note bg-surface border border-border rounded-md p-3 overflow-auto max-h-48 mt-2 text-ink font-mono whitespace-pre-wrap">
{this.state.componentStack}
                </pre>
              </details>
            )}
