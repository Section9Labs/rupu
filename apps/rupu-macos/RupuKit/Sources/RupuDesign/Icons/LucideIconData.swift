    ...
    public static func paths(for icon: LucideIcon) -> [String] {
        ...
        case .folderGit2:
            return [
                ...
                "M11 12A2 2 0 1 0 15 12A2 2 0 1 0 11 12",
                "M18 19c-2.8 0-5-2.2-5-5v8",
                "M18 19A2 2 0 1 0 22 19A2 2 0 1 0 18 19",
            ]
        case .folder:
            return [
        ...
        case .settings:
            return [
                ...
                "M9 12A3 3 0 1 0 15 12A3 3 0 1 0 9 12",
            ]
        case .radio:
            return [
                "M4.9 19.1C1 15.2 1 8.8 4.9 4.9",
                "M7.8 16.2c-2.3-2.3-2.3-6.1 0-8.5",
                "M10 12A2 2 0 1 0 14 12A2 2 0 1 0 10 12",
        ...
        case .gitBranch:
            return [
                "M6 3L6 15",
                "M15 6A3 3 0 1 0 21 6A3 3 0 1 0 15 6",
        ...
        case .userCheck:
            return [
                ...
                "M5 7A4 4 0 1 0 13 7A4 4 0 1 0 5 7",
                "M16 11L18 13L22 9",
            ]
        case .zap:
            return [
